#
 ...
 Please note that this is the direct conitnuation from the main Read Me file [this](/README.md)

Step 1 : Goto the Manage options on the left, and down below click on the "Get Started Tutorial" button<br>
